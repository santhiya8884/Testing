class India{ 							//Class name India
	static String state1="Delhi";
	static String state2="TN";			//Global static variable
	static String state3="Kerala";
...
India citizen=new India();				//Create an object
